  ...
  return (
    <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
      {cards.map((card, i) => (
        <div
          key={i}
          className={`rounded-2xl border border-k5-deepBlue/5 bg-gradient-to-br from-white to-k5-sand/5 p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-k5-digitalBlue/20 hover:shadow-xl dark:border-white/10 dark:from-k5-deepBlue dark:to-k5-deepBlue dark:hover:shadow-k5-digitalBlue/10 ${card.glow} ${i === 0 || i === 2 ? 'dark:k5-glow-blue' : ''}`}
        >
          <p className="mb-3 text-[10px] font-black uppercase tracking-[0.2em] text-k5-sand dark:text-k5-sand/80">
            {card.label}
          </p>
